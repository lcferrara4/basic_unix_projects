...
class HTTPHandler(BaseHandler):
    ...
    def _parse_request(self):
        ...
        while data:
            ...
            if key != 'COOKIE':
                key = 'HTTP_' + key
                os.environ[key] = ' '.join(data[1:])
            data = self.stream.readline().strip().split()
        '''
        try:
            data = self.stream.readline().strip().split()
            os.environ['HTTP_CONNECTION'] = data[0] #1
        except:
            data = self.stream.readline().strip()
            os.environ['HTTP_CONNECTION'] = data
        ...
        try:
            ...
            data = self.stream.readline().strip()
            os.environ['HTTP_UPGRADE_INSECURE_REQUESTS']=data
        ...
        try:
            ...
            data = self.stream.readline().strip()
            os.environ['HTTP_USER_AGENT']=data
        ...
        try:
            ...
            data = self.stream.readline().strip()
            os.environ['HTTP_ACCEPT_ENCODING']=data
        ...
        try:
            ...
            data = self.stream.readline().strip()
            os.environ['HTTP_ACCEPT_LANGUAGE']=data
        '''
